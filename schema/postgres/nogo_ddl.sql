...
CREATE TABLE principal_role (
       ...
       CONSTRAINT fk_principal_role_role_id FOREIGN KEY(role_id) REFERENCES role(role_id)
);
...
CREATE TABLE principal_groups (
       ...
       CONSTRAINT fk_principal_groups_group_id FOREIGN KEY(group_id) REFERENCES groups(group_id)
);
...
CREATE TABLE acl_entry(
       ...
       CONSTRAINT fk_acl_entry_acl_resource_id FOREIGN KEY(acl_resource_id) REFERENCES secure_resource(resource_id),
       CONSTRAINT fk_acl_entry_sid FOREIGN KEY(sid) REFERENCES sid(sid_id),
       CONSTRAINT fk_acl_entry_permission FOREIGN KEY(permission_id) REFERENCES permission(permission_id)
);
